...
| Google Forms | Applicant intake — name, email, role, CV upload |
| Google Drive | Stores uploaded CV files |
| Gemini 2.0 Flash | AI screening — scores CV and writes summary |
